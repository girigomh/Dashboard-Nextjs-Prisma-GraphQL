...
export interface InvoiceFragment_user {
  __typename: "User";
  /**
...
export interface InvoiceFragment_customer_address {
  __typename: "Address";
  /**
   * Street address
   */
...
export interface InvoiceFragment_customer {
  __typename: "Customer";
  /**
   * Unique identifier for this type
   */
   ...
   * Customer address
   */
  address: InvoiceFragment_customer_address;
}

export interface InvoiceFragment_jobType {
  __typename: "JobType";
  /**
   * Unique identifier for this type
   */
...
export interface InvoiceFragment_task {
  __typename: "Task";
  /**
   * Unique identifier for this type
   */
...
export interface InvoiceFragment_lines {
...
export interface InvoiceFragment {
   ...
   */
  user: InvoiceFragment_user;
  /**
   * Customer of the invoice - see also customerCopy
   */
  customer: InvoiceFragment_customer;
  /**
   * Job type of the invoice
   */
  jobType: InvoiceFragment_jobType | null;
  /**
   * Date when invoiced
   */
  invoiceDate: any;
   ...
   */
  task: InvoiceFragment_task | null;
  totalPrice: number;
