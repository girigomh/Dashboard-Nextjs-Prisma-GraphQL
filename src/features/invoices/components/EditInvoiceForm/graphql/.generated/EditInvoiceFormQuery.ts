...
// ====================================================
// GraphQL query operation: EditInvoiceFormQuery
// ====================================================

export interface EditInvoiceFormQuery_invoice_user {
  __typename: "User";
  /**
...
export interface EditInvoiceFormQuery_invoice_customer_address {
  __typename: "Address";
  /**
   * Street address
   */
...
export interface EditInvoiceFormQuery_invoice_customer {
  __typename: "Customer";
  /**
   * Unique identifier for this type
   */
   ...
   * Customer address
   */
  address: EditInvoiceFormQuery_invoice_customer_address;
}

export interface EditInvoiceFormQuery_invoice_jobType {
  __typename: "JobType";
  /**
   * Unique identifier for this type
   */
...
export interface EditInvoiceFormQuery_invoice_task {
  __typename: "Task";
  /**
   * Unique identifier for this type
   */
...
export interface EditInvoiceFormQuery_invoice_lines {
...
export interface EditInvoiceFormQuery_invoice {
  __typename: "Invoice";
  /**
   * Unique identifier for this type
   */
   ...
   */
  user: EditInvoiceFormQuery_invoice_user;
  /**
   * Customer of the invoice - see also customerCopy
   */
  customer: EditInvoiceFormQuery_invoice_customer;
  /**
   * Job type of the invoice
   */
  jobType: EditInvoiceFormQuery_invoice_jobType | null;
  /**
   * Date when invoiced
   */
  invoiceDate: any;
   ...
   */
  task: EditInvoiceFormQuery_invoice_task | null;
  totalPrice: number;
   ...
   * Invoice lines
   */
  lines: EditInvoiceFormQuery_invoice_lines[];
}

export interface EditInvoiceFormQuery {
  invoice: EditInvoiceFormQuery_invoice | null;
}

export interface EditInvoiceFormQueryVariables {
