...
// ====================================================
// GraphQL query operation: CopyInvoiceQuery
// ====================================================

export interface CopyInvoiceQuery_invoice_user {
  __typename: "User";
  /**
...
export interface CopyInvoiceQuery_invoice_customer_address {
  __typename: "Address";
  /**
   * Street address
   */
...
export interface CopyInvoiceQuery_invoice_customer {
  __typename: "Customer";
  /**
   * Unique identifier for this type
   */
   ...
   * Customer address
   */
  address: CopyInvoiceQuery_invoice_customer_address;
}

export interface CopyInvoiceQuery_invoice_jobType {
  __typename: "JobType";
  /**
   * Unique identifier for this type
   */
...
export interface CopyInvoiceQuery_invoice_task {
  __typename: "Task";
  /**
   * Unique identifier for this type
   */
...
export interface CopyInvoiceQuery_invoice_lines {
...
export interface CopyInvoiceQuery_invoice {
  __typename: "Invoice";
  /**
   * Unique identifier for this type
   */
   ...
   */
  user: CopyInvoiceQuery_invoice_user;
  /**
   * Customer of the invoice - see also customerCopy
   */
  customer: CopyInvoiceQuery_invoice_customer;
  /**
   * Job type of the invoice
   */
  jobType: CopyInvoiceQuery_invoice_jobType | null;
  /**
   * Date when invoiced
   */
  invoiceDate: any;
   ...
   */
  task: CopyInvoiceQuery_invoice_task | null;
  totalPrice: number;
   ...
   * Invoice lines
   */
  lines: CopyInvoiceQuery_invoice_lines[];
}

export interface CopyInvoiceQuery {
  invoice: CopyInvoiceQuery_invoice | null;
}

export interface CopyInvoiceQueryVariables {
