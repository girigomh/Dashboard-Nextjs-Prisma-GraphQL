...
import { DeductionUpdateInputArgs, WhereUniqueInputArgs, DeductionStatusEnum } from "./../../../../../../.generated/globalTypes";

// ====================================================
// GraphQL mutation operation: EditDeductionFormUpdateMutation
// ====================================================

export interface EditDeductionFormUpdateMutation_updateDeduction {
...
export interface EditDeductionFormUpdateMutation {
  updateDeduction: EditDeductionFormUpdateMutation_updateDeduction | null;
}

export interface EditDeductionFormUpdateMutationVariables {
