...
// ====================================================
// GraphQL query operation: DeductionDetailsQuery
// ====================================================

export interface DeductionDetailsQuery_deduction {
...
export interface DeductionDetailsQuery {
  deduction: DeductionDetailsQuery_deduction | null;
}

export interface DeductionDetailsQueryVariables {
