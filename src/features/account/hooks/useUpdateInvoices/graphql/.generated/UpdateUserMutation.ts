...
export interface UpdateUserMutation_updateUser_jobType {
  __typename: "JobType";
  /**
...
export interface UpdateUserMutation_updateUser_bankAccountHidden {
...
export interface UpdateUserMutation_updateUser_taxInfoHidden {
  __typename: "TaxInfo";
...
export interface UpdateUserMutation_updateUser_address {
  __typename: "Address";
  /**
   * Unique identifier for this type
   */
...
export interface UpdateUserMutation_updateUser {
   ...
   * Default job type
   */
  jobType: UpdateUserMutation_updateUser_jobType | null;
  /**
   * User bank account
   */
  bankAccountHidden: UpdateUserMutation_updateUser_bankAccountHidden | null;
  /**
   * User tax info
   */
  taxInfoHidden: UpdateUserMutation_updateUser_taxInfoHidden | null;
  /**
   * User address
   */
  address: UpdateUserMutation_updateUser_address | null;
}
