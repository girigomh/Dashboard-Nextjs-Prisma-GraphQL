...
export interface CustomerFragment_address_country {
  __typename: "Country";
  /**
...
export interface CustomerFragment_address {
  __typename: "Address";
  /**
   * Unique identifier for this type
   */
   ...
   */
  country: CustomerFragment_address_country;
  /**
   * City of the address
   */
  city: string;
...
export interface CustomerFragment_user {
  __typename: "User";
  /**
   * Unique identifier for this type
   */
...
export interface CustomerFragment {
   ...
   * Customer address
   */
  address: CustomerFragment_address;
  /**
   * Owner of the customer
   */
  user: CustomerFragment_user;
  /**
   * Customer EAN number
   */
  ean: any | null;
