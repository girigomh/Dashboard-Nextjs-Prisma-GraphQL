...
// ====================================================
// GraphQL query operation: TaskDetailsQuery
// ====================================================

export interface TaskDetailsQuery_task_customer_address {
  __typename: "Address";
  /**
   * Street address
   */
...
export interface TaskDetailsQuery_task_customer {
  __typename: "Customer";
  /**
   ...
   * Customer address
   */
  address: TaskDetailsQuery_task_customer_address;
}

export interface TaskDetailsQuery_task_jobType {
  __typename: "JobType";
  /**
   * Unique identifier for this type
   */
...
export interface TaskDetailsQuery_task_user {
  __typename: "User";
  /**
   * Unique identifier for this type
   */
...
export interface TaskDetailsQuery_task {
  __typename: "Task";
  /**
   * Unique identifier for this type
   */
   ...
   */
  customer: TaskDetailsQuery_task_customer;
  /**
   * Job type of the task
   */
  jobType: TaskDetailsQuery_task_jobType;
  /**
   * Owner of the task
   */
  user: TaskDetailsQuery_task_user;
  /**
...
export interface TaskDetailsQuery {
  task: TaskDetailsQuery_task | null;
}
