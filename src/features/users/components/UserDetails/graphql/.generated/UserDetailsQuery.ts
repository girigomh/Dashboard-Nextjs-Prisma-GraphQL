...
export interface UserDetailsQuery_user_jobType {
  __typename: "JobType";
  /**
...
export interface UserDetailsQuery_user_bankAccount {
...
export interface UserDetailsQuery_user_taxInfo {
  __typename: "TaxInfo";
...
export interface UserDetailsQuery_user_bankAccountHidden {
  __typename: "BankAccount";
  bankName: string | null;
  bankAccount: string | null;
  bankRegistration: string | null;
...
export interface UserDetailsQuery_user_taxInfoHidden {
  __typename: "TaxInfo";
  personId: string | null;
  taxCard: string | null;
  countryId: any | null;
...
export interface UserDetailsQuery_user_address_country {
  __typename: "Country";
  /**
   * Unique identifier for this type
   */
...
export interface UserDetailsQuery_user_address {
  __typename: "Address";
  /**
   * Unique identifier for this type
   */
   ...
   */
  country: UserDetailsQuery_user_address_country;
}
...
export interface UserDetailsQuery_user {
   ...
   * Default job type
   */
  jobType: UserDetailsQuery_user_jobType | null;
  /**
   * User bank account
   */
  bankAccount: UserDetailsQuery_user_bankAccount | null;
  /**
   * User tax info
   */
  taxInfo: UserDetailsQuery_user_taxInfo | null;
  /**
   * User bank account
   */
  bankAccountHidden: UserDetailsQuery_user_bankAccountHidden | null;
  /**
   * User tax info
   */
  taxInfoHidden: UserDetailsQuery_user_taxInfoHidden | null;
  /**
   * User address
   */
  address: UserDetailsQuery_user_address | null;
}
